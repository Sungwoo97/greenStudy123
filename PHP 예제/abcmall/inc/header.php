...
//최근 본 상품 조회
if(isset($_COOKIE['recent_viewed'])){     //recent_viewed 쿠키가 있다면
  $rvArr = json_decode($_COOKIE['recent_viewed']);  // 문자열로 되어있는 recent_viewed쿠키의 값을 $reArr 배열에 추가
  $rvString = implode(",", $rvArr); //rvArr를 분할하고 분할 기준마다 ","을 추가하여 저장
                                ...
                                <div class="header-cart-menu d-flex align-items-center ml-auto">
                                    ...
                                    <div class="cart">
                                        <a href="#" id="header-cart-btn" target="_blank"><span
                                                class="cart_quantity">
                                                <?php
                                                echo isset($cartArr)? sizeof($cartArr): 0;
                                                ?>
                                        ...
                                        <ul class="cart-list">
                                          ...
                                          ?>
                                            <li>
                                                ...
                                                <div class="cart-item-desc">
                                                    ...
                                                    <p><?= $cart->cnt ?>x - <span class="price "><string class="number"><?= $cart->price ?></string> 원</span></p>
                                                </div>
                                          ...
                                          ?>
                                            <li class="total">
                                                <span class="pull-right ">Total: <string class="number"><?= $total ?></string> 원</span>
