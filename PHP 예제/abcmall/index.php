...
/* products 테이블에서 모든 상품을 조회하고 그 결과를 $result에 담고
$result에 담긴 값에서 fetch_object()로 값들을 연관배열에 담고
$data에 할당
그 값이 있을때 마다 (while) 변수명 $dataArr에 값을 추가한다.
*/
...
/*
category 테이블의 대분류를 조회해서 변수명 $cateArr에 할당
*/
$cate_sql = "SELECT * FROM category WHERE step = 1 LIMIT 0, 6";
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-7">
                                        ...
                                        <form class="cart" method="post">
                                            ...
                                            <button type="submit" name="aditemocart" value="5" class="cart-submit">Add to
                                                cart</button>
                                            <!-- Wishlist -->
