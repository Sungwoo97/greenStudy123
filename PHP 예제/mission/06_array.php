...
<body>
  ...
  <?php
    ...
    $langs[0] = 'html';// 인덱스 번호 0에 해당 하는 값 할당
    $langs[1] = 'css';// 인덱스 번호 1에 해당 하는 값 할당
    $langs[2] = 'javascript';// 인덱스 번호 2에 해당 하는 값 할당

    echo $langs[1]; //인덱스 번호 1에 해당 하는 값 출력
    ?>
  <h3>1-2</h3>
  ...
  <?php
    $langs = array('구조' => 'html', '스타일' => 'css', '동적요소' => 'javascript'); // 배열 생성과 값 생성        
    echo $langs['동적요소'];//'동적요소'의 value 출력
  ?>
</body>
</html>
